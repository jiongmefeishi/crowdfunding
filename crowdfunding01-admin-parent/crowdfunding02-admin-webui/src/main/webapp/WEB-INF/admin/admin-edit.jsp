            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="admin/update.html" method="post" role="form">
                        <%--
                            关键的隐藏信息，提交修改时需要携带，此隐藏信息的admin.id来源于admin-page页面点击修改按钮时从后台的toEidtPage()方法返回
                            隐藏信息pageNun和keyword，由于点击修改按钮和admin-page 展示页面是同一个http的请求，没有重定向，所以里面存在pageNum和keyword，
                            不需要再从后台携带
                         --%>
